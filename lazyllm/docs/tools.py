...
ChromaStore is a vector-capable store implementation based on Chroma, inheriting from LazyLLMStoreBase. 
...
Delete an entire collection or specific records from Chroma.
...
Retrieve records from Chroma matching the given criteria.
